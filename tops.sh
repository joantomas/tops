...
{
	local first_option all_short_options='eh'
	first_option="${1:0:1}"
...
_positionals=()
_arg_workspace_path="${PWD}"
# THE DEFAULTS INITIALIZATION - OPTIONALS
_arg_env_file="${HOME}/.env"


print_help()
{
	printf '%s\n' "<The general help message of my script>"
	printf 'Usage: %s [-e|--env-file <arg>] [-h|--help] [<workspace-path>]\n' "$0"
	printf '\t%s\n' "<workspace-path>: Workspace path (default: '"${PWD}"')"
	printf '\t%s\n' "-e, --env-file: Environment file (default: '"${HOME}/.env"')"
	printf '\t%s\n' "-h, --help: Prints help"
}
	...
	do
		...
		case "$_key" in
			-e|--env-file)
				...
				;;
			--env-file=*)
				_arg_env_file="${_key##--env-file=}"
				;;
			-e*)
				_arg_env_file="${_key##-e}"
				;;
			-h|--help)
				print_help
				exit 0
...
assign_positional_args()
{
	...
	_positional_names="_arg_workspace_path "
